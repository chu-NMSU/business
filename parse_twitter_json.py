...
with codecs.open('twitter_data/twitter-2011.txt', 'w', 'utf-8') as outfile1, codecs.open('twitter_data/twitter-2013.txt', 'w', 'utf-8') as outfile2:
    for user in users:
        user_text2011 = ''
        user_text2013 = ''

        with open('twitter_data/'+user+'.json') as infile, codecs.open('twitter_data/'+user+'-2011.txt', 'w', 'utf-8') as user_outfile1, codecs.open('twitter_data/'+user+'-2013.txt', 'w', 'utf-8') as user_outfile2:
